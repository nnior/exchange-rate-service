...
CREATE TABLE EXCHANGE (
    ID INTEGER IDENTITY PRIMARY KEY,
    BASE_ASSET CHAR(3) NOT NULL,
    QUOTE_ASSET CHAR(3) NOT NULL,
    RATE DECIMAL NOT NULL
);

INSERT INTO CURRENCY (SYMBOL, DESCRIPTION) VALUES ('AED', 'United Arab Emirates Dirham'),
...
('UYU', 'Uruguayan Peso'), ('UZS', 'Uzbekistan Som'), ('VEF', 'Venezuelan Bolívar Fuerte (Old)'),
('VES', 'Venezuelan Bolívar Soberano'), ('VND', 'Vietnamese Dong'), ('VUV', 'Vanuatu Vatu'),
('WST', 'Samoan Tala'), ('XAF', 'CFA Franc BEAC'), ('XAG', 'Silver Ounce'),
('XAU', 'Gold Ounce'), ('XCD', 'East Caribbean Dollar'), ('XDR', 'Special Drawing Rights'),
